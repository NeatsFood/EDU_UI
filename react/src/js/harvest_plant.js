                ...
                {this.state.successfully_submitted ? <div className="row measurements-row">
                    ...
                    <div className="row measurements-row">
                        <div className="col-md-12">
                            ...
                            <div className="row">
                                <h3> Congratulations on your grow! Please submit your climate recipe to share with the community. </h3>
                            </div>
                        </div>
                    </div>
                    <div className="row measurements-row">
                    ...
                    <div className="row measurements-row">
                        ...
                        <div className="col-md-9">
                            <Input onChange={this.sensorOnChange} name="plant_weight_with_roots" placeholder="Weight in (lbs)"/>
                        </div>
                    </div>
                    <div className="row measurements-row">
                        <div className="col-md-3">
                        ...
                        <div className="col-md-9">
                            <Input onChange={this.sensorOnChange} name="plant_weight_without_roots" placeholder="Weight in (lbs)"/>
                        </div>
                    </div>
                    <div className="row measurements-row">
                        <div className="col-md-3">
                                    ...
                                    <div className="row">
                                        <img className={classNames({
                                            ...
                                            'leaf-wither-with-border': this.selectedBorder("YELLOW", "leaf_colors")
                                             ...
                                             width="100" height="100" src={yellow} alt=''
                                    ...
                                    <div className="row">
                                        <img className={classNames({
                                            ...
                                            'leaf-wither-with-border': this.selectedBorder("YELLOWGREEN", "leaf_colors")
                                             ...
                                             width="100" height="100" src={yellowgreen} alt=''
                                    ...
                                    <div className="row">
                                        <img className={classNames({
                                            ...
                                            'leaf-wither-with-border': this.selectedBorder("LUSHGREEN", "leaf_colors")
                                             ...
                                             width="100" height="100" src={lushgreen} alt=''
                                    ...
                                    <div className="row">
                                        <img className={classNames({
                                            ...
                                            'leaf-wither-with-border': this.selectedBorder("DARKGREEN", "leaf_colors")
                                             ...
                                             width="100" height="100" src={darkgreen} alt=''
