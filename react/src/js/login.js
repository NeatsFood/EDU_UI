        ...
        return fetch(process.env.REACT_APP_FLASK_URL + '/login/', {
            ...
            .then((responseJson) => {
                ...
                if (responseJson["response_code"] === 200) {
                    ...
                    // we expire the cookie in just under 24 hours (they are good in the DB for 24.
                    this.props.cookies.set('user_token', responseJson['user_token'], {maxAge: (60 * 60 * 24) -  60});
            ...
            <div className="login-page">
                <div className="form">
                    ...
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <p className="message">Not registered? <button onClick={this.signUpClick}> Create an account </button></p>
                    </form>
                </div>
            </div>
        )
