                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-4 pull-right no-padding-right">
                                        {this.state.discourse_key === '' ?<Button className="edit-button-full"
                                                onClick={this.toggle_discourse_modal} title='Coming Soon'  ><img src={discourse_icon} alt=''
                                                                                           height="30"/> Connect
                                            Forum</Button>:<Button className="edit-button-full"
                                               title='Coming Soon'  ><img src={discourse_icon} alt=''
                                    ...
                                    <div className="col-md-4 pull-right no-padding-right">
                                        {this.state.edit_profile ?
                                            ...
                                            <Button className="edit-button"
                                                ...
                                                <img className="small-pad" src={edit_icon} height="30" alt=''/> Edit Profile
                                            </Button>
                                        }
                                    </div>
                                </div>
